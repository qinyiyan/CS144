...
public class ItemServlet extends HttpServlet implements Servlet {
    ...
    public static ItemBean makeItem(Document doc){
    	...
    	if (itemId == "" || itemId ==null)
	    	...
	    	//bids
	    	Element bidInfoElement = getElementByTagNameNR(itemElement,"Bids");
	    	Element[] bidsElement;
	    	if (bidInfoElement != null){
	    		 bidsElement= getElementsByTagNameNR(bidInfoElement,"Bid");
	    	}
	    	else {
	    		bidsElement = new Element[0];
	    	}
